# # we went with this approach, qwen3 embed, 1600,200, The indexing and tool creation is in same file, so we split responsibilities. We create 'index_docs.py' to index and 'all_tools.py' to create tools.
...
def main() -> None:
    ...
    # New collection name for Qwen3 embeddings
    ...
    if REBUILD_INDEX:
        ...
        # Second level chunking with size 800 and overlap 200
        docs = chunk_docs(docs, chunk_size=800, chunk_overlap=200)
